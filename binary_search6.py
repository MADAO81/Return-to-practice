...
res1 = timeit.timeit('ys1 = sigmoid_precise(xs)', number=100, globals={'xs': xs, 'sigmoid_precise': sigmoid_precise})
print(res1)
res2 = timeit.timeit(
    'ys2 = vectorize(Sigmoid.calculate)(xs)',
    number=100,
    globals={'xs': xs, 'sigmoid_precise': sigmoid_precise, 'vectorize': vectorize, 'Sigmoid': Sigmoid}
)
print(res2)
#print(diff(ys2, ys1))
